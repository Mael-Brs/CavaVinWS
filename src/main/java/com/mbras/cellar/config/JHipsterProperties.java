...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "cavaVin@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "cavaVin API";

        private String description = "cavaVin API documentation";
