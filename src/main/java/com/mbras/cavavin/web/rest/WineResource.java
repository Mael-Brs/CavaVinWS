...
public class WineResource {
    ...
    public ResponseEntity<Wine> createWine(@Valid @RequestBody Wine wine) throws URISyntaxException {
        ...
        if (wine.getId() != null) {
            throw new BadRequestAlertException("A new wine cannot already have an ID", ENTITY_NAME, "idexists");
        }
    ...
    @GetMapping("/wines")
    @Timed
    public ResponseEntity<List<Wine>> getAllWines(Pageable pageable) {
    ...
    @Timed
    public ResponseEntity<List<Wine>> searchWines(@RequestParam String query, Pageable pageable) {
