...
public class WineInCellarResourceIntTest {
    ...
    private static final Integer DEFAULT_APOGEE = 1;
    private static final Integer UPDATED_APOGEE = 2;
    ...
    public void createWineInCellar() throws Exception {
        ...
        assertThat(testWineInCellar.getApogee()).isEqualTo(DEFAULT_APOGEE);
        ...
        assertThat(testWineInCellar.getCellarId()).isEqualTo(DEFAULT_CELLAR_ID);
    ...
    public void updateWineInCellar() throws Exception {
        ...
        assertThat(testWineInCellar.getApogee()).isEqualTo(UPDATED_APOGEE);
